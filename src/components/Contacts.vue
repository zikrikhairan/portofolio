    ...
    <div class="section-content">
      <div class="row">
          ...
          <div class="col-md-6 col-sm-6">
            <form @submit="formSubmited" action="http://formspree.io/zikrikhairan156@gmail.com" target="_blank" method="post">
              <label class="form-group">
                <div class="title-input">
                  <div><span class="star-required">*</span>Full Name:</div>
                  <transition name="fadeRight">
                    <div class="validation" v-if="!isValidName">Name is required!</div>
                  </transition>
                </div>
              ...
              <label class="form-group">
                <div class="title-input">
                  ...
                  <transition name="fadeRight">
                    <div class="validation" v-if="!isValidName">E-mail is required!</div>
                  </transition>
                </div>
              ...
              <label class="form-group">
                <div class="title-input">
                  ...
                  <transition name="fadeRight">
                    <div class="validation" v-if="!isValidName">Enter something, please...</div>
                  </transition>
                </div>
